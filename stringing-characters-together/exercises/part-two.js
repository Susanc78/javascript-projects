...
let newString2 = newString.toUpperCase();
...
let newString3 = dnaTwo.replace("GCT","AGG");
...
let dnaThree = dnaTwo.slice("20","23");
console.log(dnaThree);
//4) Use a template literal to print, "The DNA strand is ___ characters long."
let dnaString = String(dnaTwo).length;
console.log(`The DNA strand is ${dnaString} characters long.`);
