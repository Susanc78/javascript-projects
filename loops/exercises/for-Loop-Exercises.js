...
//1.a Print the numbers 0-20, on number per line.
for (let i = 0; i <21; i++) {
    console.log(i);
}
...
//1.d challenge- print the numbers 50-20 in descending order, but only if the numbers are multiples of 3
for (let i = 50; i > 20; i--) {
  if (i % 3 === 0) {
    console.log(i);
  }
...
/*Exercise #3:Construct a for loop that sorts the array [2, 3, 13, 18, -5, 38, -10, 11, 0, 104] into two new arrays:
  ...
  for (let i = 0; i < numArray.length; i++) {
    if (numArray[i] % 2 === 0) {
      array2.push(numArray[i]); 
    } else {
      array3.push(numArray[i]);
    }
  }
  console.log(`Even Numbers: ${array2}\n Odd Numbers: ${array3}`);
